...
```bash
$ git clone https://github.com/dodeadityaa/Dodebot.git
Cloning into 'Dodebot'...
...
```bash
$ virtualenv env
New python executable in ./Dodebot/env/bin/python2.7
Also creating executable in ./Dodebot/env/bin/python
...
```python
kik = KikApi('dodebot', '5a888dcb-4c6e-1973-b15t-308e1854f0ba')
```
